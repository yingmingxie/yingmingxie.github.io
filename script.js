...
const translations = {
  en: {
    ...
    "home.welcome1": "We are a theoretical condensed matter physics group at the School of Physics and Astronomy, Shanghai Jiao Tong University. We use field theory, symmetry analysis, and numerical computation to understand quantum properties of matter, working closely with experiments to explore quantum science.",
    ...
    "opening.shortText": "The group is well funded and welcomes motivated students and postdocs.",
    ...
    "news.home1": "<strong>06/2026</strong> - XIE Lab starts at Shanghai Jiao Tong University. Open positions are available.",
    ...
    "members.name": "Ying-Ming Xie",
    "members.pi": "Principal Investigator",
    "members.rank": "Associate Professor",
    "members.award": "Selected for the National Excellent Young Scientists Fund Program (Overseas), 2025",
    "members.affiliation": "School of Physics and Astronomy, Shanghai Jiao Tong University",
    ...
    "publications.intro": "Selected representative publications. For the full list, see Google Scholar and arXiv.",
    "news.title": "News",
    "news.list1": "<strong>06/2026</strong> - XIE Lab starts at Shanghai Jiao Tong University.",
    ...
    "opening.intro": "The group has strong funding support and welcomes motivated undergraduate students, graduate students, and postdocs interested in quantum condensed matter theory and computation.",
    ...
    "opening.applyText": "Please send a CV.",
  ...
  zh: {
    ...
    "nav.opening": "招生招聘",
    "hero.title": "量子物质理论",
    "hero.subtitle": "拓扑 · 关联 · 超导 · 量子几何",
    "home.welcomeTitle": "欢迎来到 XIE Lab",
    "home.welcome1": "我们是上海交通大学物理与天文学院的理论凝聚态物理课题组，用场论、群论及数值计算等方法预测和理解物质的量子特性，并与实验紧密合作，探索量子科学。",
    "home.welcome2": "目前的研究兴趣包括低维关联量子体系理论，拓扑超导及拓扑量子计算，量子材料的输运及调控理论等。",
    "opening.shortTitle": "招生招聘",
    "opening.shortText": "目前课题组经费充足，欢迎对量子凝聚态理论和计算感兴趣的学生和博士后加入。",
    "opening.postdoc": "博士后",
    "opening.grad": "研究生",
    "opening.undergrad": "本科生科研项目",
    "opening.details": "查看招生招聘信息",
    "news.latest": "最新消息",
    "news.home1": "<strong>2026/06</strong> - XIE Lab 在上海交通大学成立，欢迎学生和博士后加入。",
    ...
    "members.pi": "课题组负责人",
    "members.rank": "副教授",
    "members.award": "入选国家优秀青年科学基金项目（海外）（2025）",
    "members.affiliation": "上海交通大学物理与天文学院",
    ...
    "publications.intro": "以下为部分代表性论文。完整的论文见 Google Scholar、arXiv。",
    "news.title": "新闻",
    "news.list1": "<strong>2026/06</strong> - XIE Lab 在上海交通大学成立。",
    ...
    "gallery.title": "相册",
    "gallery.intro": "记录 XIE Lab 的组合影、学术交流、会议活动和日常科研生活。",
    "gallery.placeholder1": "XIE Lab @ SJTU",
    "gallery.placeholder2": "学术报告与交流",
    "gallery.placeholder3": "组内生活",
    "gallery.caption1": "组合影与校园瞬间",
    "gallery.caption2": "学术访问、邀请报告和研讨会",
    "gallery.caption3": "组内活动、聚餐和日常片段",
    "opening.title": "招生招聘",
    "opening.intro": "目前课题组经费充足，欢迎对量子凝聚态理论和计算感兴趣的本科生、研究生和博士后联系加入。",
