...
const translations = {
  en: {
    ...
    "news.home1": "<strong>06/2026</strong> - XIE Group starts at the Institute of Condensed Matter Physics, School of Physics and Astronomy, Shanghai Jiao Tong University. Open positions are available.",
    ...
    "news.title": "News",
    "news.list1": "<strong>06/2026</strong> - XIE Group starts at the Institute of Condensed Matter Physics, School of Physics and Astronomy, Shanghai Jiao Tong University.",
    ...
    "gallery.intro": "Selected moments from group life, seminars, conferences, and everyday research at XIE Group.",
    "gallery.placeholder1": "XIE Group @ SJTU",
    ...
    "footer.copy": "© <span data-year></span> XIE Group, Shanghai Jiao Tong University"
  },
  zh: {
    ...
    "home.welcomeTitle": "欢迎来到 XIE Group",
    ...
    "news.latest": "最新消息",
    "news.home1": "<strong>2026/06</strong> - XIE Group 在上海交通大学物理与天文学院凝聚态物理研究所成立，欢迎本科生、硕士生、博士生和博士后加入。",
    ...
    "news.title": "新闻",
    "news.list1": "<strong>2026/06</strong> - XIE Group 在上海交通大学物理与天文学院凝聚态物理研究所成立。",
    ...
    "gallery.title": "相册",
    "gallery.intro": "记录 XIE Group 的组内合影、学术交流、会议活动和日常科研生活。",
    "gallery.placeholder1": "XIE Group @ SJTU",
    ...
    "footer.copy": "© <span data-year></span> XIE Group，上海交通大学"
  }
};
